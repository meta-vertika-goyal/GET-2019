...
public class HexCalc
{
	...
	{
		long inthex1=convertHexToDecimal(hexnum1);
		long inthex2=convertHexToDecimal(hexnum2);
		long sum=inthex1+inthex2;
		String resulthex=convertDecimalToHex(sum);
		return resulthex;		
	...
	public static String subtract(String hexnum1,String hexnum2)
	{
		...
		long intHex1=convertHexToDecimal(larger);
		long intHex2=convertHexToDecimal(smaller);
		
		
		long difference=intHex1-intHex2;
		String resulthex=convertDecimalToHex(difference);
		return resulthex;		
	...
	public static String multiply(String hexnum1,String hexnum2)
	{
		...
		String resulthex=convertDecimalToHex(product);
		return resulthex;		
	...
	public static String divide(String hexnum1,String hexnum2)
	{
		...
		String resulthex=convertDecimalToHex(quotient);
		return resulthex;		
